...
// In main/include/CHIPProjectConfig.h (or your project config header)
#define CHIP_IM_MRP_CONFIG_IDLE_RETRY_INTERVAL_MS   500
#define CHIP_IM_MRP_CONFIG_ACTIVE_RETRY_INTERVAL_MS 300   
#define CHIP_IM_MRP_LOCAL_IDLE_RETRY_TIMEOUT_MS     8000  


// Spec 8.5.1 requires enough slots for 5 read requests per fabric with 9 paths each.
#ifndef CHIP_IM_SERVER_MAX_NUM_PATH_GROUPS_FOR_READS
#define CHIP_IM_SERVER_MAX_NUM_PATH_GROUPS_FOR_READS 45
#elif CHIP_IM_SERVER_MAX_NUM_PATH_GROUPS_FOR_READS < 45
#undef CHIP_IM_SERVER_MAX_NUM_PATH_GROUPS_FOR_READS
#define CHIP_IM_SERVER_MAX_NUM_PATH_GROUPS_FOR_READS 45
#endif

#ifndef CHIP_IM_MAX_NUM_READS
#define CHIP_IM_MAX_NUM_READS 5
#elif CHIP_IM_MAX_NUM_READS < 5
#undef CHIP_IM_MAX_NUM_READS
#define CHIP_IM_MAX_NUM_READS 5
#endif
